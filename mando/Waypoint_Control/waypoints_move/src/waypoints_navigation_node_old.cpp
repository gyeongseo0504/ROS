...
int main(int argc, char **argv)
{
	...
	std::string waypoint_file_name = "/home/amap/2024_onefifth_catkin_ws/shark_full.txt";
	...
	{	
		...
		if(run_flag == 1)
		{
			...
			if(wp_go_id >=1)
			{
				...
				wp_line_equation_msg.data.push_back(Waypoints_line_equation[wp_go_id-1].b_utm);  // 배열 요소 1 // 배열 요소 2
			...
			else
			{
				...
				wp_line_equation_msg.data.push_back(Waypoints_line_equation[0].b_utm);  // 배열 요소 1 // 배열 요소 2
				wp_line_equation_pub.publish(wp_line_equation_msg);
